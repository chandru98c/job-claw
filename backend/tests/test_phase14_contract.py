...
async def test_prepare_contract(client: AsyncClient, async_db_session: AsyncSession, setup_data):
    ...
    # Patch get_current_profile_id
    import app.api.recommendations
    original_get_profile = app.api.recommendations.get_current_profile_id
    app.api.recommendations.get_current_profile_id = lambda req: req.headers.get("X-Profile-ID", "default_profile_id")
    ...
    try:
        ...
        app.api.recommendations.get_current_profile_id = original_get_profile
